package com.gridgain.dih.kafka.avro;
...
public class Trade extends org.apache.avro.specific.SpecificRecordBase
	 ...
	 */
	public static com.gridgain.dih.kafka.avro.Trade.Builder newBuilder() {
		return new com.gridgain.dih.kafka.avro.Trade.Builder();
	}
	 ...
	 */
	public static com.gridgain.dih.kafka.avro.Trade.Builder newBuilder(
			com.gridgain.dih.kafka.avro.Trade.Builder other) {
		if (other == null) {
			return new com.gridgain.dih.kafka.avro.Trade.Builder();
		} else {
			return new com.gridgain.dih.kafka.avro.Trade.Builder(other);
		}
	}
	 ...
	 * @return A new Trade RecordBuilder
	 */
	public static com.gridgain.dih.kafka.avro.Trade.Builder newBuilder(com.gridgain.dih.kafka.avro.Trade other) {
		if (other == null) {
			return new com.gridgain.dih.kafka.avro.Trade.Builder();
		} else {
			return new com.gridgain.dih.kafka.avro.Trade.Builder(other);
	...
	public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Trade>
		 ...
		 * @param other The existing Builder to copy.
		 */
		private Builder(com.gridgain.dih.kafka.avro.Trade.Builder other) {
			super(other);
		 ...
		 * @param other The existing instance to copy.
		 */
		private Builder(com.gridgain.dih.kafka.avro.Trade other) {
			super(SCHEMA$, MODEL$);
			if (isValidValue(fields()[0], other.id)) {
				this.id = data().deepCopy(fields()[0].schema(), other.id);
		 ...
		 * @return This builder.
		 */
		public com.gridgain.dih.kafka.avro.Trade.Builder setId(java.lang.String value) {
		 ...
		 * @return This builder.
		 */
		public com.gridgain.dih.kafka.avro.Trade.Builder clearId() {
			id = null;
		 ...
		 * @return This builder.
		 */
		public com.gridgain.dih.kafka.avro.Trade.Builder setAccountId(java.lang.String value) {
		 ...
		 * @return This builder.
		 */
		public com.gridgain.dih.kafka.avro.Trade.Builder clearAccountId() {
			accountId = null;
		 ...
		 * @return This builder.
		 */
		public com.gridgain.dih.kafka.avro.Trade.Builder setSymbol(java.lang.String value) {
		 ...
		 * @return This builder.
		 */
		public com.gridgain.dih.kafka.avro.Trade.Builder clearSymbol() {
			symbol = null;
		 ...
		 * @return This builder.
		 */
		public com.gridgain.dih.kafka.avro.Trade.Builder setOrderQuantity(int value) {
		 ...
		 * @return This builder.
		 */
		public com.gridgain.dih.kafka.avro.Trade.Builder clearOrderQuantity() {
		 ...
		 * @return This builder.
		 */
		public com.gridgain.dih.kafka.avro.Trade.Builder setBidPrice(double value) {
		 ...
		 * @return This builder.
		 */
		public com.gridgain.dih.kafka.avro.Trade.Builder clearBidPrice() {
		 ...
		 * @return This builder.
		 */
		public com.gridgain.dih.kafka.avro.Trade.Builder setTradeType(java.lang.String value) {
		 ...
		 * @return This builder.
		 */
		public com.gridgain.dih.kafka.avro.Trade.Builder clearTradeType() {
			trade_type = null;
		 ...
		 * @return This builder.
		 */
		public com.gridgain.dih.kafka.avro.Trade.Builder setOrderDate(long value) {
		 ...
		 * @return This builder.
		 */
		public com.gridgain.dih.kafka.avro.Trade.Builder clearOrderDate() {
