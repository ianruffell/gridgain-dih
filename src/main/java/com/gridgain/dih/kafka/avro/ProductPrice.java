...
public class ProductPrice extends org.apache.avro.specific.SpecificRecordBase
	 ...
	 */
	public static com.gridgain.dih.kafka.avro.ProductPrice.Builder newBuilder() {
		return new com.gridgain.dih.kafka.avro.ProductPrice.Builder();
	}
	 ...
	 */
	public static com.gridgain.dih.kafka.avro.ProductPrice.Builder newBuilder(
			com.gridgain.dih.kafka.avro.ProductPrice.Builder other) {
		if (other == null) {
			return new com.gridgain.dih.kafka.avro.ProductPrice.Builder();
		} else {
			return new com.gridgain.dih.kafka.avro.ProductPrice.Builder(other);
		}
	}
	 ...
	 */
	public static com.gridgain.dih.kafka.avro.ProductPrice.Builder newBuilder(
			com.gridgain.dih.kafka.avro.ProductPrice other) {
		if (other == null) {
			return new com.gridgain.dih.kafka.avro.ProductPrice.Builder();
		} else {
			return new com.gridgain.dih.kafka.avro.ProductPrice.Builder(other);
	...
	public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ProductPrice>
		 ...
		 * @param other The existing Builder to copy.
		 */
		private Builder(com.gridgain.dih.kafka.avro.ProductPrice.Builder other) {
			super(other);
		 ...
		 * @param other The existing instance to copy.
		 */
		private Builder(com.gridgain.dih.kafka.avro.ProductPrice other) {
			super(SCHEMA$, MODEL$);
			if (isValidValue(fields()[0], other.id)) {
				this.id = data().deepCopy(fields()[0].schema(), other.id);
		 ...
		 * @return This builder.
		 */
		public com.gridgain.dih.kafka.avro.ProductPrice.Builder setId(java.lang.String value) {
		 ...
		 * @return This builder.
		 */
		public com.gridgain.dih.kafka.avro.ProductPrice.Builder clearId() {
			id = null;
		 ...
		 * @return This builder.
		 */
		public com.gridgain.dih.kafka.avro.ProductPrice.Builder setTime(long value) {
		 ...
		 * @return This builder.
		 */
		public com.gridgain.dih.kafka.avro.ProductPrice.Builder clearTime() {
		 ...
		 * @return This builder.
		 */
		public com.gridgain.dih.kafka.avro.ProductPrice.Builder setSymbol(java.lang.String value) {
		 ...
		 * @return This builder.
		 */
		public com.gridgain.dih.kafka.avro.ProductPrice.Builder clearSymbol() {
			symbol = null;
		 ...
		 * @return This builder.
		 */
		public com.gridgain.dih.kafka.avro.ProductPrice.Builder setPrice(double value) {
		 ...
		 * @return This builder.
		 */
		public com.gridgain.dih.kafka.avro.ProductPrice.Builder clearPrice() {
