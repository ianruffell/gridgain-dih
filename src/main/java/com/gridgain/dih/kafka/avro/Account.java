...
public class Account extends org.apache.avro.specific.SpecificRecordBase
	 ...
	 */
	public static com.gridgain.dih.kafka.avro.Account.Builder newBuilder() {
		return new com.gridgain.dih.kafka.avro.Account.Builder();
	}
	 ...
	 */
	public static com.gridgain.dih.kafka.avro.Account.Builder newBuilder(
			com.gridgain.dih.kafka.avro.Account.Builder other) {
		if (other == null) {
			return new com.gridgain.dih.kafka.avro.Account.Builder();
		} else {
			return new com.gridgain.dih.kafka.avro.Account.Builder(other);
		}
	}
	 ...
	 * @return A new Account RecordBuilder
	 */
	public static com.gridgain.dih.kafka.avro.Account.Builder newBuilder(com.gridgain.dih.kafka.avro.Account other) {
		if (other == null) {
			return new com.gridgain.dih.kafka.avro.Account.Builder();
		} else {
			return new com.gridgain.dih.kafka.avro.Account.Builder(other);
	...
	public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Account>
		 ...
		 * @param other The existing Builder to copy.
		 */
		private Builder(com.gridgain.dih.kafka.avro.Account.Builder other) {
			super(other);
		 ...
		 * @param other The existing instance to copy.
		 */
		private Builder(com.gridgain.dih.kafka.avro.Account other) {
			super(SCHEMA$, MODEL$);
			if (isValidValue(fields()[0], other.id)) {
				this.id = data().deepCopy(fields()[0].schema(), other.id);
		 ...
		 * @return This builder.
		 */
		public com.gridgain.dih.kafka.avro.Account.Builder setId(java.lang.String value) {
		 ...
		 * @return This builder.
		 */
		public com.gridgain.dih.kafka.avro.Account.Builder clearId() {
			id = null;
		 ...
		 * @return This builder.
		 */
		public com.gridgain.dih.kafka.avro.Account.Builder setName(java.lang.String value) {
		 ...
		 * @return This builder.
		 */
		public com.gridgain.dih.kafka.avro.Account.Builder clearName() {
			name = null;
