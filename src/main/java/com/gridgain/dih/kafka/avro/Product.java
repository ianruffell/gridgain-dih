...
public class Product extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
	public static com.gridgain.dih.kafka.avro.Product.Builder newBuilder() {
		return new com.gridgain.dih.kafka.avro.Product.Builder();
  }
   ...
   */
	public static com.gridgain.dih.kafka.avro.Product.Builder newBuilder(
			com.gridgain.dih.kafka.avro.Product.Builder other) {
    if (other == null) {
			return new com.gridgain.dih.kafka.avro.Product.Builder();
    } else {
			return new com.gridgain.dih.kafka.avro.Product.Builder(other);
    }
  }
   ...
   * @return A new Product RecordBuilder
   */
	public static com.gridgain.dih.kafka.avro.Product.Builder newBuilder(com.gridgain.dih.kafka.avro.Product other) {
    if (other == null) {
			return new com.gridgain.dih.kafka.avro.Product.Builder();
    } else {
			return new com.gridgain.dih.kafka.avro.Product.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Product>
     ...
     * @param other The existing Builder to copy.
     */
	private Builder(com.gridgain.dih.kafka.avro.Product.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
	private Builder(com.gridgain.dih.kafka.avro.Product other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.symbol)) {
        this.symbol = data().deepCopy(fields()[0].schema(), other.symbol);
    ...
    /**
      ...
      * @return This builder.
      */
	public com.gridgain.dih.kafka.avro.Product.Builder setSymbol(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
	public com.gridgain.dih.kafka.avro.Product.Builder clearSymbol() {
      symbol = null;
    ...
    /**
      ...
      * @return This builder.
      */
	public com.gridgain.dih.kafka.avro.Product.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
	public com.gridgain.dih.kafka.avro.Product.Builder clearName() {
      name = null;
