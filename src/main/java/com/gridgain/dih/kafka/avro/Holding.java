...
public class Holding extends org.apache.avro.specific.SpecificRecordBase
	 ...
	 */
	public static com.gridgain.dih.kafka.avro.Holding.Builder newBuilder() {
		return new com.gridgain.dih.kafka.avro.Holding.Builder();
	}
	 ...
	 */
	public static com.gridgain.dih.kafka.avro.Holding.Builder newBuilder(
			com.gridgain.dih.kafka.avro.Holding.Builder other) {
		if (other == null) {
			return new com.gridgain.dih.kafka.avro.Holding.Builder();
		} else {
			return new com.gridgain.dih.kafka.avro.Holding.Builder(other);
		}
	}
	 ...
	 * @return A new Holding RecordBuilder
	 */
	public static com.gridgain.dih.kafka.avro.Holding.Builder newBuilder(com.gridgain.dih.kafka.avro.Holding other) {
		if (other == null) {
			return new com.gridgain.dih.kafka.avro.Holding.Builder();
		} else {
			return new com.gridgain.dih.kafka.avro.Holding.Builder(other);
	...
	public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Holding>
		 ...
		 * @param other The existing Builder to copy.
		 */
		private Builder(com.gridgain.dih.kafka.avro.Holding.Builder other) {
			super(other);
		 ...
		 * @param other The existing instance to copy.
		 */
		private Builder(com.gridgain.dih.kafka.avro.Holding other) {
			super(SCHEMA$, MODEL$);
			if (isValidValue(fields()[0], other.id)) {
				this.id = data().deepCopy(fields()[0].schema(), other.id);
		 ...
		 * @return This builder.
		 */
		public com.gridgain.dih.kafka.avro.Holding.Builder setId(java.lang.String value) {
		 ...
		 * @return This builder.
		 */
		public com.gridgain.dih.kafka.avro.Holding.Builder clearId() {
			id = null;
		 ...
		 * @return This builder.
		 */
		public com.gridgain.dih.kafka.avro.Holding.Builder setAccountId(java.lang.String value) {
		 ...
		 * @return This builder.
		 */
		public com.gridgain.dih.kafka.avro.Holding.Builder clearAccountId() {
			accountId = null;
		 ...
		 * @return This builder.
		 */
		public com.gridgain.dih.kafka.avro.Holding.Builder setLastTradeDate(long value) {
		 ...
		 * @return This builder.
		 */
		public com.gridgain.dih.kafka.avro.Holding.Builder clearLastTradeDate() {
		 ...
		 * @return This builder.
		 */
		public com.gridgain.dih.kafka.avro.Holding.Builder setShareCount(long value) {
		 ...
		 * @return This builder.
		 */
		public com.gridgain.dih.kafka.avro.Holding.Builder clearShareCount() {
		 ...
		 * @return This builder.
		 */
		public com.gridgain.dih.kafka.avro.Holding.Builder setSymbol(java.lang.String value) {
		 ...
		 * @return This builder.
		 */
		public com.gridgain.dih.kafka.avro.Holding.Builder clearSymbol() {
			symbol = null;
